...
public class ApiResponseFactory {
   ...
   private static void getPayAndChargeLog(List<XmlElement> var0, PayAndChargeLogs var1, String var2) {
      ...
      if(var0 != null && var0.size() > 0) {
         ...
         while(var3.hasNext()) {
            ...
            var5.time = Utils.formatDate(Utils.getLong(var4.getAttribute("create_time")));
            ...
            if("consume".equals(var2)) {
               ...
               var5.type = 2;
               var5.sourceType = Utils.getInt(var4.getAttribute("source_type"));
            }
	...
	public static Object getResponse(Context context, int i,
			HttpResponse httpresponse) {
		String s = null;
		if (MarketAPI.ACTION_GET_ALIPAY_ORDER_INFO == i || MarketAPI.ACTION_QUERY_ALIPAY_RESULT == i) {
			s = Utils.getStringResponse(httpresponse);
			if (TextUtils.isEmpty(s))
				return null;
		}

		if (MarketAPI.ACTION_CHECK_LOG_LEVEL == i || MarketAPI.ACTION_INSERT_LOG == i) {
			s = Utils.getGzipStringResponse(httpresponse);
			if (TextUtils.isEmpty(s))
				return null;
		}

		InputStream inputstream = Utils.getInputStreamResponse(httpresponse);
		if (null == inputstream) {
			return null;
		}
		...
		try {
			...
			case MarketAPI.ACTION_GET_ALIPAY_ORDER_INFO:
		        ...
		        try {
					obj = parseGetAlipayOrderInfo(s);
				} catch (JSONException e1) {
					Utils.D((new StringBuilder()).append(s1).append(" has JSONException").toString(), e1);
				}
		        break;
			...
			case MarketAPI.ACTION_GET_REQUIRED:
				...
				obj = parseGetRequired(context, XmlElement.parseXml(inputstream));
		        break;
			...
			case MarketAPI.ACTION_INSERT_LOG:
		        ...
		        try {
					obj = Boolean.valueOf(parseSubmitLog(s));
				} catch (JSONException e1) {
					Utils.D((new StringBuilder()).append(s1).append(" has JSONException").toString(), e1);
				}
				break;
			case MarketAPI.ACTION_GET_MASTER_RECOMMEND:
				...
				obj = parseMasterRecommend(context, XmlElement.parseXml(inputstream));
		        break;
			...
			case MarketAPI.ACTION_GET_MASTER_CONTAINS:
				...
				obj = parseMasterContains(context, XmlElement.parseXml(inputstream));
		        break;
			...
			case MarketAPI.ACTION_FOLLOW_MASTER:
				...
				obj = Boolean.valueOf(parseFllowResult(XmlElement.parseXml(inputstream)));
		        break;
			case MarketAPI.ACTION_GET_FOLLOWED_RECOMMEND:
				s1 = "ACTION_GET_FOLLOWED_RECOMMEND";
				obj = parseFllowedRecommend(context, XmlElement.parseXml(inputstream));
		        break;
			case MarketAPI.ACTION_GET_HOME_MASTER_RECOMMEND:
				s1 = "ACTION_GET_HOME_MASTER_RECOMMEND";
				obj = parseHomeMasterRecommend(context, XmlElement.parseXml(inputstream));
		        break;
			case MarketAPI.ACTION_MARK_READ:
				s1 = "ACTION_MARK_READ";
				obj = Boolean.valueOf(parseMarkAsRead(XmlElement.parseXml(inputstream)));
				break;
			...
			Utils.D((new StringBuilder()).append(s1).append(" has XmlPullParserException").toString(), e);
		} catch (IOException e) {
			Utils.D((new StringBuilder()).append(s1).append(" has IOException").toString(), e);
		}
		return obj;
	}

   private static ArrayList<HashMap<String, Object>> parseAllCategory(XmlElement var0) {
      ...
      if(var0 == null) {
         ...
         if(var1 != null) {
            ...
            for(int var3 = 1; var3 < var1.size(); ++var3) {
               ...
               var25.put("category_name", var24.getAttribute("category_name"));
               var25.put("app_count", var24.getAttribute("app_count"));
               var25.put("icon_url", var24.getAttribute("icon_url"));
               String var29 = var24.getChild("sub_category", 0).getAttribute("category_name") + ", ";
               ...
               while(var35.hasNext()) {
                  ...
                  var39.put("category_id", var38.getAttribute("category_id"));
                  var39.put("category_name", var38.getAttribute("category_name"));
            ...
            Iterator<XmlElement> var4 = ((XmlElement)var1.get(0)).getChildren("sub_category").iterator();
            ...
            while(var4.hasNext()) {
               ...
               var7.put("category_name", var6.getAttribute("category_name"));
         ...
         if(var1 != null) {
            ...
            if(var3 > 0) {
               ...
               while(var6.hasNext()) {
                  ...
                  var10.put("date", Utils.formatTime(Utils.getLong(var9.getAttribute("date"))));
                  var5.add(var10);
               }
   ...
   private static HashMap<String, Object> parseFllowedRecommend(Context var0, XmlElement var1) {
      HashMap var8;
      if(var1 == null) {
         var8 = null;
      } else {
         HashMap var2 = new HashMap();
         var2.put("total_size", Integer.valueOf(Utils.getInt(var1.getAttribute("total_size"))));
         var2.put("total_unread", Integer.valueOf(Utils.getInt(var1.getAttribute("total_unread"))));
         ArrayList var5 = new ArrayList();
         List var6 = var1.getChildren("recommend");
         HashMap var11;
         if(var6 != null) {
            for(Iterator var9 = var6.iterator(); var9.hasNext(); var5.add(var11)) {
               ...
               Object[] var16 = new Object[]{DateUtils.getRelativeTimeSpanString(Utils.getLong(var10.getAttribute("update_time")), System.currentTimeMillis(), 60000L, 262144)};
               var11.put("update_time", var0.getString(2131296638, var16));
   ...
   private static JSONObject parseGetAlipayOrderInfo(String var0) throws JSONException {
      byte[] var1 = Base64.decodeBase64(var0);
      return new JSONObject(new String((new Crypter()).decrypt(var1, SecurityUtil.SECRET_KEY_HTTP_CHARGE_ALIPAY)));
   }
   ...
   private static PayAndChargeLogs parseGetPayLog(Context var0, XmlElement var1) {
      ...
      if(var1 == null) {
         ...
         if(var2 != null) {
            ...
            var3.endPosition = Utils.getInt(var2.getAttribute("end_position"));
         ...
         if(var2 != null && var2.size() > 0) {
            ...
            while(var6.hasNext()) {
               ...
               if(var11 != null && var11.size() != 0) {
                  for(Iterator var13 = var11.iterator(); var13.hasNext(); var4.add(var15)) {
                     ...
                     var15.put("app_detail", var14.getAttribute("short_description"));
      ...
      if(var1 == null) {
         ...
         if(var3 != null && var3.size() > 0) {
            ...
            while(var5.hasNext()) {
               ...
               Object[] var12 = new Object[]{DateUtils.getRelativeTimeSpanString(Utils.getLong(var6.getAttribute("update_time")), System.currentTimeMillis(), 60000L, 262144)};
               var7.put("update_time", var0.getString(2131296638, var12));
   ...
   private static HashMap<String, String> parseLogLevel(String var0) throws JSONException {
   ...
   private static HashMap<String, String> parseLoginOrRegisterResult(XmlElement var0) {
      HashMap var1;
      if(var0 == null) {
         var1 = null;
      } else {
      ...
      if(var1 == null) {
         ...
         if(var5 != null) {
            ...
            while(var8.hasNext()) {
               ...
               Object[] var15 = new Object[]{DateUtils.getRelativeTimeSpanString(Utils.getLong(var9.getAttribute("update_time")), System.currentTimeMillis(), 60000L, 262144)};
               var10.put("update_time", var0.getString(2131296638, var15));
   ...
   private static boolean parseNotificationRecommend(Context var0, XmlElement var1) {
      boolean var5;
      if(var1 == null) {
         var5 = false;
      } else {
   ...
   private static Object parseProductDetail(XmlElement var0) {
      ...
      if(var0 == null) {
         ...
         if(var1 != null) {
            ...
            var2.setPayCategory(Utils.getInt(var1.getAttribute("pay_category")));
            ...
            var2.setVersionCode(Utils.getInt(var1.getAttribute("version_code")));
            var2.setCommentsCount(Utils.getInt(var1.getAttribute("comments_count")));
            var2.setRatingCount(Utils.getInt(var1.getAttribute("ratings_count")));
            var2.setDownloadCount(Utils.getInt(var1.getAttribute("download_count")));
            var2.setLongDescription(var1.getAttribute("long_description"));
            var2.setAuthorName(var1.getAttribute("author_name"));
            var2.setPublishTime((long)Utils.getInt(var1.getAttribute("publish_time")));
            String[] var3 = new String[]{var1.getAttribute("screenshot_1"), var1.getAttribute("screenshot_2"), var1.getAttribute("screenshot_3"), var1.getAttribute("screenshot_4"), var1.getAttribute("screenshot_5")};
            var2.setScreenshot(var3);
            String[] var4 = new String[]{var1.getAttribute("screenshot_1"), var1.getAttribute("screenshot_2"), var1.getAttribute("screenshot_3"), var1.getAttribute("screenshot_4"), var1.getAttribute("screenshot_5")};
   ...
   private static HashMap<String, Object> parseProductList(Context var0, XmlElement var1, boolean var2) {
      HashMap var4;
      if(var1 == null) {
         var4 = null;
      } else {
         ...
         if(var3 != null) {
            ...
            if(var6 == null) {
               ...
               HashMap var7 = new HashMap();
               var7.put("total_size", Integer.valueOf(Utils.getInt(var3.getAttribute("total_size"))));
               var7.put("end_position", Integer.valueOf(Utils.getInt(var3.getAttribute("end_position"))));
               ...
               while(var11.hasNext()) {
                  ...
                  String var20;
                  if(var18 == 0) {
                     var20 = var0.getString(2131296484);
                  } else {
                     Object[] var19 = new Object[]{Integer.valueOf(var18)};
                     var20 = var0.getString(2131296452, var19);
                  }
                  ...
                  var14.put("author_name", var13.getAttribute("author_name"));
                  var14.put("sub_category", var13.getAttribute("product_type") + " > " + var13.getAttribute("sub_category"));
                  var14.put("pay_category", Integer.valueOf(Utils.getInt(var13.getAttribute("pay_category"))));
                  var14.put("rating", Float.valueOf((float)Utils.getInt(var13.getAttribute("rating")) / 10.0F));
                  var14.put("app_size", StringUtils.formatSize(var13.getAttribute("app_size")));
                  var14.put("icon_url", var13.getAttribute("icon_url"));
                  var14.put("short_description", var13.getAttribute("short_description"));
                  if("1".equals(var13.getAttribute("source_type"))) {
                     var14.put("source_type", var0.getString(2131296437));
                  }
   ...
   private static void parseProductListResult(Context var0, XmlElement var1, HashMap<String, Object> var2) {
      ...
      if(var3 != null) {
         ...
         HashMap var9;
         for(Iterator var6 = var3.iterator(); var6.hasNext(); var5.add(var9)) {
            ...
            String var15;
            if(var13 == 0) {
               var15 = var0.getString(2131296484);
            } else {
               Object[] var14 = new Object[]{Integer.valueOf(var13)};
               var15 = var0.getString(2131296452, var14);
            }
            ...
            var9.put("sub_category", var8.getAttribute("product_type") + " > " + var8.getAttribute("sub_category"));
            var9.put("pay_category", Integer.valueOf(Utils.getInt(var8.getAttribute("pay_category"))));
            var9.put("rating", Float.valueOf((float)Utils.getInt(var8.getAttribute("rating")) / 10.0F));
            var9.put("app_size", StringUtils.formatSize(var8.getAttribute("app_size")));
            var9.put("icon_url", var8.getAttribute("icon_url"));
            var9.put("short_description", var8.getAttribute("short_description"));
            if("1".equals(var8.getAttribute("source_type"))) {
               var9.put("source_type", var0.getString(2131296437));
            }
         }
   ...
   private static boolean parseSubmitLog(String var0) throws JSONException {
      boolean var1;
      if("success".equalsIgnoreCase((new JSONObject(var0)).getString("result"))) {
         var1 = true;
      } else {
         var1 = false;
      }
   ...
   private static Object parseSyncApps(XmlElement var0) {
      ...
      if(var0 == null) {
         ...
         var1 = new UpdateInfo();
         var1.setUpdageLevel(Integer.valueOf(var0.getChild("update_level", 0).getText()).intValue());
         var1.setVersionCode(Integer.valueOf(var0.getChild("version_code", 0).getText()).intValue());
   ...
   private static CardsVerifications parseSyncCardinfo(Context var0, XmlElement var1) {
      ...
      if(var1 == null) {
         ...
         while(var3.hasNext()) {
            ...
            var5.accountNum = Utils.getInt(var4.getAttribute("account_len"));
            var5.passwordNum = Utils.getInt(var4.getAttribute("password_len"));
   ...
   private static ArrayList<HashMap<String, Object>> parseTopRecommend(XmlElement var0) {
      ArrayList var4;
      if(var0 == null) {
         var4 = null;
      } else {
   ...
   private static ArrayList<HashMap<String, Object>> parseTopicList(Context var0, XmlElement var1) {
      ArrayList var3;
      if(var1 == null) {
         var3 = null;
      } else {
         ...
         if(var2 != null) {
            ...
            while(var6.hasNext()) {
               ...
               if(!"5".equals(var9)) {
                  ...
                  var8.put("icon_url", var7.getAttribute("ldpi_app_icon_url"));
         ...
         if(var2 != null) {
            ...
            if(var4 == null) {
               ...
               while(var6.hasNext()) {
                  ...
                  var8.versionCode = Utils.getInt(var7.getAttribute("version_code"));
