...
public class MarketAPI {
	...
	// 自己测试
	public static final int ACTION_STARTD = 100; // 起始
	public static final int ACTION_LOGIN_EX = 100;
	public static final int ACTION_REGISTER_EX = 101;
	public static final int ACTION_EXIT_EX = 102;
	public static final int ACTION_GETUSERINFO_EX = 103;
	public static final int ACTION_CHKUNAME_EX = 104;
	public static final int ACTION_GETFREMPRODUCT_EX = 105;
	public static final int ACTION_GETREMPRODUCT_EX = 106;
	public static final int ACTION_GETHOTPRODUCT_EX = 107;
	public static final int ACTION_GETCATALOG_EX = 108;
	public static final int ACTION_PUSHDATAINSTALL_EX = 109;
	public static final int ACTION_GETINSTALLMSG_EX = 110;
	public static final int ACTION_SETINSTALLMSGSTATUS_EX = 111;
	public static final int ACTION_SETIMSTATUS_EX = 112;
	public static final int ACTION_PRODUCTDETAIL_EX = 113;
	public static final int ACTION_PRODUCTSEARCH_EX = 114;
	public static final int ACTION_ADDCOMMENT_EX = 115;
	public static final int ACTION_GETCOMMENTLIST_EX = 116;

	static final String[] API_URLS_EX = new String[] {
			"http://192.168.108.235/http/login.html",								//0
			"http://192.168.108.235/http/register.html", 							//1
			"http://192.168.108.235/http/exit.html",								//2
			"http://192.168.108.235/http/getSessionUserInfo.html",		//3
			"http://192.168.108.235/http/chkUname.html",						//4
			"http://192.168.108.235/http/getFremproduct.html",				//5
			"http://192.168.108.235/http/getRemproduct.html", 				//6
			"http://192.168.108.235/http/getHotproduct.html", 				// 7 	获得热门的产品
			"http://192.168.108.235/http/getCatalog.html",						// 8	获得类目信息
			"http://192.168.108.235/http/pushDataInstall.html",				//9 	推送安装消息
			"http://192.168.108.235/http/getInstallMsg.html",				//10	获得安装消息列表
			"http://192.168.108.235/http/setInstallMsgStatus.html",	//11.	设置安装消息的状态
			"http://192.168.108.235/http/bSetIMStatus.html",				//12批量设置安装消息的状态
			"http://192.168.108.235/http/detail.html",							//13显示产品详情
			"http://192.168.108.235/http/search.html",						//14	产品搜索
			"http://192.168.108.235/http/addComment.html",				//15	添加评论
			"http://192.168.108.235/http/getCommentList.html"			//16	获得评论列表
	};
	...
	public static void loginEX(Context context,
			ApiAsyncTask.ApiRequestListener requestListener, String username,
			String password) {
		HashMap<String, String> hmap = new HashMap<String, String>(2);
		hmap.put("username", username);
		hmap.put("password", password);
		(new ApiAsyncTask(context, ACTION_LOGIN_EX, requestListener, hmap))
				.execute(new Void[0]);
	}
	
	public static void registerEX(Context context,
			ApiAsyncTask.ApiRequestListener requestListener, String username,
			String password) {
		HashMap<String, String> hmap = new HashMap<String, String>(2);
		hmap.put("username", username);
		hmap.put("password", password);
		(new ApiAsyncTask(context, ACTION_REGISTER_EX, requestListener, hmap))
				.execute(new Void[0]);
	}
	
	//获得重点推荐的产品
	public static void getFremproductEX(Context context,ApiAsyncTask.ApiRequestListener requestListener) {
		commonAPIEX(context, requestListener, ACTION_GETFREMPRODUCT_EX);
	}
	
	//获得推荐的产品
	public static void getRemproductEX(Context context,ApiAsyncTask.ApiRequestListener requestListener) {
		commonAPIEX(context, requestListener, ACTION_GETREMPRODUCT_EX);
	}
	
	//获得热门的产品
	public static void getHotproductEX(Context context,ApiAsyncTask.ApiRequestListener requestListener) {
		commonAPIEX(context, requestListener, ACTION_GETHOTPRODUCT_EX);
	}
	
	//获得类目信息
	public static void getCatalogEX(Context context,ApiAsyncTask.ApiRequestListener requestListener) {
		(new ApiAsyncTask(context, ACTION_GETCATALOG_EX, requestListener, null)).execute(new Void[0]);
	}
	
	//产品详情
	public static void productDetailEX(Context context,ApiAsyncTask.ApiRequestListener requestListener, 
			int productID) {
		HashMap<String, Object> hmap = new HashMap<String, Object>(1);
		String sid = Session.get(context).getSid();
		if (sid != null){
			hmap.put("sid", sid);
		}
		hmap.put("pid", Integer.valueOf(productID));
		(new ApiAsyncTask(context, ACTION_PRODUCTDETAIL_EX, requestListener, hmap)).execute(new Void[0]);
	}
	
	// 产品搜索
	public static void searchProductEX(Context context,ApiAsyncTask.ApiRequestListener requestListener, 
			int catalogID, String orderby, String searchKey) {
		//http://www.appstore.com/http/search.html?cid=1&orderby=publish_date&language=1&key=g
		HashMap<String, Object> hmap = new HashMap<String, Object>(4);
		String sid = Session.get(context).getSid();
		if (sid != null){
			hmap.put("sid", sid);
		}
		hmap.put("cid", Integer.valueOf(catalogID));
		hmap.put("orderby", orderby);
		hmap.put("language", Integer.valueOf(1)); // 简体中文
		hmap.put("key", searchKey);
		(new ApiAsyncTask(context, ACTION_PRODUCTSEARCH_EX, requestListener, hmap)).execute(new Void[0]);
	}
	
	// 获取评论列表
	public static void getCommentListEX(Context context, ApiAsyncTask.ApiRequestListener requestListener, 
			int pageNo, int productID) {
		HashMap<String, Object> hmap = new HashMap<String, Object>(2);
		hmap.put("pageNo", Integer.valueOf(pageNo));
		hmap.put("pid", Integer.valueOf(productID));
		(new ApiAsyncTask(context, ACTION_GETCOMMENTLIST_EX, requestListener, hmap)).execute(new Void[0]);
	}
	
	// 添加评论,必须要sid(即必须登录)
	public static void addCommentEX(Context context, ApiAsyncTask.ApiRequestListener requestListener, 
			String sid, String title, String content, int score, int productID, String version) {
		HashMap<String, Object> hmap = new HashMap<String, Object>(6);
		hmap.put("sid", sid);
		hmap.put("title", title);
		hmap.put("content", content);
		hmap.put("score", Integer.valueOf(score));
		hmap.put("product_id", Integer.valueOf(productID));
		hmap.put("version", version);
		(new ApiAsyncTask(context, ACTION_ADDCOMMENT_EX, requestListener, hmap)).execute(new Void[0]);
	}
	
	public static void commonAPIEX(Context context,ApiAsyncTask.ApiRequestListener requestListener, int action){
		HashMap<String, String> hmap = null;
		String sid = Session.get(context).getSid();
		if (sid != null){
			hmap = new HashMap<String, String>(1);
			hmap.put("sid", sid);
		}
		(new ApiAsyncTask(context, action, requestListener, hmap)).execute(new Void[0]);
	}
	

	public static void addComment(Context var0,
			ApiAsyncTask.ApiRequestListener var1, String var2, String var3) {
		Session var4 = Session.get(var0);
		String var5 = SecurityUtil.encryptPassword(var4.getPassword(),
				var4.getUserName());
		String var6 = Utils.getUTF8String(Base64.encodeBase64(DigestUtils
				.md5(var4.getUserName() + var2 + var5)));
		...
		(new ApiAsyncTask(var0, ACTION_ADD_COMMENT, var1, var7))
				.execute(new Void[0]);
	}

	public static void addMasterRecommendDiscuss(Context var0,
			ApiAsyncTask.ApiRequestListener var1, String var2, String var3) {
		Session var4 = Session.get(var0);
		String var5 = SecurityUtil.encryptPassword(var4.getPassword(),
				var4.getUserName());
		...
		var7.put("password", var5);
		var7.put("verify_code", var6);
		(new ApiAsyncTask(var0, ACTION_ADD_DISCUSS, var1, var7))
				.execute(new Void[0]);
	}

	public static void addMasterRecommendRating(Context var0,
			ApiAsyncTask.ApiRequestListener var1, int var2, String var3) {
		HashMap var4 = new HashMap(2);
		var4.put("promotion_id", var3);
		var4.put("rating", Integer.valueOf(var2));
		(new ApiAsyncTask(var0, ACTION_ADD_RECOMMEND_RATING, var1, var4))
				.execute(new Void[0]);
	}

	public static void addRating(Context var0,
			ApiAsyncTask.ApiRequestListener var1, String var2, int var3) {
		Session var4 = Session.get(var0);
		String var5 = SecurityUtil.encryptPassword(var4.getPassword(),
				var4.getUserName());
		String var6 = Utils.getUTF8String(Base64.encodeBase64(DigestUtils
		...
		var7.put("password", var5);
		var7.put("verify_code", var6);
		(new ApiAsyncTask(var0, ACTION_ADD_RATING, var1, var7))
				.execute(new Void[0]);
	}

	public static void bindAccount(Context var0,
			ApiAsyncTask.ApiRequestListener var1) {
		...
		(new ApiAsyncTask(var0, ACTION_BIND_ACCOUNT, var1, var3))
				.execute(new Void[0]);
	}

	public static void charge(Context var0,
			ApiAsyncTask.ApiRequestListener var1, String var2, String var3,
			CardInfo var4) {
		...
		var6.put(
				"password",
				SecurityUtil.encryptPassword(var2,
						String.valueOf(var5.getUid())));
		var6.put("type", var3);
		...
		(new ApiAsyncTask(var0, ACTION_CHARGE, var1, var6))
				.execute(new Void[0]);
	}

	public static void checkLogLevel(Context var0,
			ApiAsyncTask.ApiRequestListener var1) {
		(new ApiAsyncTask(var0, ACTION_CHECK_LOG_LEVEL, var1, new String[] {
				"download", "crash_mobile" })).execute(new Void[0]);
	}

	public static void checkNewSplash(Context var0,
			ApiAsyncTask.ApiRequestListener var1) {
		Session var2 = Session.get(var0);
		HashMap var3 = new HashMap(4);
		...
		(new ApiAsyncTask(var0, ACTION_CHECK_NEW_SPLASH, var1, var3))
				.execute(new Void[0]);
	}

	public static void checkUpdate(Context var0,
			ApiAsyncTask.ApiRequestListener var1) {
		Session var2 = Session.get(var0);
		HashMap var3 = new HashMap(4);
		var3.put("package_name", var2.getPackageName());
		...
		(new ApiAsyncTask(var0, ACTION_CHECK_NEW_VERSION, var1, var3))
				.execute(new Void[0]);
	}

	public static void checkUpgrade(Context var0,
			ApiAsyncTask.ApiRequestListener var1) {
		HashMap var2 = new HashMap(1);
		var2.put("upgradeList", Utils.getInstalledApps(var0));
		(new ApiAsyncTask(var0, ACTION_CHECK_UPGRADE, var1, var2))
				.execute(new Void[0]);
	}

	public static void getAliPayOrder(Context var0,
			ApiAsyncTask.ApiRequestListener var1, int var2, String var3,
			String var4) {
		Session var5 = Session.get(var0);
		...
		(new ApiAsyncTask(var0, ACTION_GET_ALIPAY_ORDER_INFO, var1, var6))
				.execute(new Void[0]);
	}

	public static void getAllCategory(Context var0,
			ApiAsyncTask.ApiRequestListener var1) {
		...
		(new ApiAsyncTask(var0, ACTION_GET_ALL_CATEGORY, var1, var2))
				.execute(new Void[0]);
	}

	public static void getBalance(Context var0,
			ApiAsyncTask.ApiRequestListener var1) {
		Session var2 = Session.get(var0);
		HashMap var3 = new HashMap(1);
		var3.put("uid", var2.getUid());
		(new ApiAsyncTask(var0, ACTION_GET_BALANCE, var1, var3))
				.execute(new Void[0]);
	}

	public static void getCategory(Context var0,
			ApiAsyncTask.ApiRequestListener var1, String var2) {
		Session var3 = Session.get(var0);
		...
		(new ApiAsyncTask(var0, ACTION_GET_CATEGORY, var1, var4))
				.execute(new Void[0]);
	}

	public static void getComments(Context var0,
			ApiAsyncTask.ApiRequestListener var1, String var2, int var3,
			int var4) {
		...
		(new ApiAsyncTask(var0, ACTION_GET_COMMENTS, var1, var5))
				.execute(new Void[0]);
	}

	public static void getConsumeDetail(Context var0,
			ApiAsyncTask.ApiRequestListener var1, String var2, String var3) {
		HashMap var4 = new HashMap(2);
		var4.put("uid", var2);
		var4.put("type", var3);
		(new ApiAsyncTask(var0, ACTION_GET_CONSUME_DETAIL, var1, var4))
				.execute(new Void[0]);
	}

	public static void getConsumeSum(Context var0,
			ApiAsyncTask.ApiRequestListener var1, String var2) {
		HashMap var3 = new HashMap(1);
		var3.put("uid", var2);
		(new ApiAsyncTask(var0, ACTION_GET_CONSUMESUM, var1, var3))
				.execute(new Void[0]);
	}

	public static void getDownloadUrl(Context var0,
			ApiAsyncTask.ApiRequestListener var1, String var2, String var3) {
		Session var4 = Session.get(var0);
		HashMap var5 = new HashMap(3);
		var5.put("p_id", var2);
		...
		(new ApiAsyncTask(var0, ACTION_GET_DOWNLOAD_URL, var1, var5))
				.execute(new Void[0]);
	}

	public static void getFollowedRecommend(Context var0,
			ApiAsyncTask.ApiRequestListener var1) {
		HashMap var2 = new HashMap(1);
		Session var3 = Session.get(var0);
		var2.put("platform", Integer.valueOf(var3.getOsVersion()));
		...
		var2.put("uid", var7);
		(new ApiAsyncTask(var0, ACTION_GET_FOLLOWED_RECOMMEND, var1, var2))
				.execute(new Void[0]);
	}

	public static void getGrowFast(Context var0,
			ApiAsyncTask.ApiRequestListener var1, int var2, int var3) {
		Session var4 = Session.get(var0);
		...
		(new ApiAsyncTask(var0, ACTION_GET_GROW_FAST, var1, var5))
				.execute(new Void[0]);
	}

	public static void getHomeMasterRecommend(Context var0,
			ApiAsyncTask.ApiRequestListener var1) {
		HashMap var2 = new HashMap(3);
		Session var3 = Session.get(var0);
		var2.put("platform", Integer.valueOf(var3.getOsVersion()));
		var2.put("screen_size", var3.getScreenSize());
		var2.put("match_type", Integer.valueOf(var3.isFilterApps()));
		(new ApiAsyncTask(var0, ACTION_GET_HOME_MASTER_RECOMMEND, var1, var2))
				.execute(new Void[0]);
	}

	public static void getHomeRecommend(Context var0,
			ApiAsyncTask.ApiRequestListener var1, int var2, int var3) {
		Session var4 = Session.get(var0);
		HashMap var5 = new HashMap(5);
		var5.put("size", Integer.valueOf(var3));
		...
		var5.put("screen_size", var4.getScreenSize());
		var5.put("match_type", Integer.valueOf(var4.isFilterApps()));
		(new ApiAsyncTask(var0, ACTION_GET_HOME_RECOMMEND, var1, var5))
				.execute(new Void[0]);
	}

	public static void getMasterContains(Context var0,
			ApiAsyncTask.ApiRequestListener var1, String var2) {
		HashMap var3 = new HashMap(4);
		Session var4 = Session.get(var0);
		...
		var3.put("p_id", var2);
		(new ApiAsyncTask(var0, ACTION_GET_MASTER_CONTAINS, var1, var3))
				.execute(new Void[0]);
	}

	public static void getMasterRecommend(Context var0,
			ApiAsyncTask.ApiRequestListener var1, int var2, int var3) {
		...
		(new ApiAsyncTask(var0, ACTION_GET_MASTER_RECOMMEND, var1, var4))
				.execute(new Void[0]);
	}

	public static void getMasterRecommendApps(Context var0,
			ApiAsyncTask.ApiRequestListener var1, int var2, int var3,
			String var4) {
		Session var5 = Session.get(var0);
		...
		(new ApiAsyncTask(var0, ACTION_GET_MASTER_RECOMMEND_APPS, var1, var6))
				.execute(new Void[0]);
	}

	public static void getMasterRecommendDiscuss(Context var0,
			ApiAsyncTask.ApiRequestListener var1, int var2, int var3,
			String var4) {
		HashMap var5 = new HashMap(3);
		...
		(new ApiAsyncTask(var0, ACTION_GET_DISCUSS, var1, var5))
				.execute(new Void[0]);
	}

	public static void getMasterRecommendRating(Context var0,
			ApiAsyncTask.ApiRequestListener var1, String var2) {
		HashMap var3 = new HashMap(1);
		var3.put("promotion_id", var2);
		(new ApiAsyncTask(var0, ACTION_GET_RECOMMEND_RATING, var1, var3))
				.execute(new Void[0]);
	}

	public static void getMyRating(Context var0,
			ApiAsyncTask.ApiRequestListener var1, String var2) {
		Session var3 = Session.get(var0);
		HashMap var4 = new HashMap(2);
		var4.put("uid", var3.getUid());
		var4.put("p_id", var2);
		(new ApiAsyncTask(var0, ACTION_GET_MYRATING, var1, var4))
				.execute(new Void[0]);
	}

	public static void getNotificationRecommend(Context var0,
			ApiAsyncTask.ApiRequestListener var1) {
		HashMap var2 = new HashMap(3);
		Session var3 = Session.get(var0);
		var2.put("platform", Integer.valueOf(var3.getOsVersion()));
		...
		(new ApiAsyncTask(var0, ACTION_GET_RECOMMEND_NOTIFICATION, var1, var2))
				.execute(new Void[0]);
	}

	public static void getPayLog(Context var0,
			ApiAsyncTask.ApiRequestListener var1, int var2, int var3) {
		Session var4 = Session.get(var0);
		HashMap var5 = new HashMap(3);
		var5.put("uid", var4.getUid());
		var5.put("start_position", Integer.valueOf(var2));
		var5.put("size", Integer.valueOf(var3));
		(new ApiAsyncTask(var0, ACTION_GET_PAY_LOG, var1, var5))
				.execute(new Void[0]);
	}

	public static void getProductDetailWithId(Context var0,
			ApiAsyncTask.ApiRequestListener var1, int var2, String var3,
			String var4) {
		HashMap var5 = new HashMap(3);
		...
		(new ApiAsyncTask(var0, ACTION_GET_PRODUCT_DETAIL, var1, var5))
				.execute(new Void[0]);
	}

	public static void getProductDetailWithPackageName(Context var0,
			ApiAsyncTask.ApiRequestListener var1, int var2, String var3) {
		HashMap var4 = new HashMap(3);
		var4.put("local_version", Integer.valueOf(var2));
		var4.put("packagename", var3);
		(new ApiAsyncTask(var0, ACTION_GET_DETAIL, var1, var4))
				.execute(new Void[0]);
	}

	public static void getProducts(Context var0,
			ApiAsyncTask.ApiRequestListener var1, int var2, int var3, int var4,
			String var5) {
		...
		(new ApiAsyncTask(var0, ACTION_GET_PRODUCTS, var1, var7))
				.execute(new Void[0]);
	}

	public static void getRankByCategory(Context var0,
			ApiAsyncTask.ApiRequestListener var1, int var2, int var3,
			String var4) {
		Session var5 = Session.get(var0);
		HashMap var6 = new HashMap(6);
		...
		var6.put("screen_size", var5.getScreenSize());
		var6.put("match_type", Integer.valueOf(var5.isFilterApps()));
		(new ApiAsyncTask(var0, ACTION_GET_RANK_BY_CATEGORY, var1, var6))
				.execute(new Void[0]);
	}

	public static void getRecommendByApp(Context var0,
			ApiAsyncTask.ApiRequestListener var1, String var2) {
		HashMap var3 = new HashMap(4);
		Session var4 = Session.get(var0);
		var3.put("platform", Integer.valueOf(var4.getOsVersion()));
		...
		var3.put("match_type", Integer.valueOf(var4.isFilterApps()));
		var3.put("p_id", var2);
		(new ApiAsyncTask(var0, ACTION_GET_RECOMMEND_BY_APP, var1, var3))
				.execute(new Void[0]);
	}

	public static void getRecommendProducts(Context var0,
			ApiAsyncTask.ApiRequestListener var1, String var2, int var3,
			int var4) {
		Session var5 = Session.get(var0);
		HashMap var6 = new HashMap(6);
		...
		var6.put("screen_size", var5.getScreenSize());
		var6.put("match_type", Integer.valueOf(var5.isFilterApps()));
		(new ApiAsyncTask(var0, ACTION_GET_RECOMMEND_PRODUCTS, var1, var6))
				.execute(new Void[0]);
	}

	public static void getRequired(Context var0,
			ApiAsyncTask.ApiRequestListener var1) {
		HashMap var2 = new HashMap(3);
		Session var3 = Session.get(var0);
		var2.put("platform", Integer.valueOf(var3.getOsVersion()));
		var2.put("screen_size", var3.getScreenSize());
		var2.put("match_type", Integer.valueOf(var3.isFilterApps()));
		(new ApiAsyncTask(var0, ACTION_GET_REQUIRED, var1, var2))
				.execute(new Void[0]);
	}

	public static void getSearchFromBBS(Context var0,
			ApiAsyncTask.ApiRequestListener var1, String var2, int var3,
			int var4) {
		...
		(new ApiAsyncTask(var0, ACTION_BBS_SEARCH, var1, var5))
				.execute(new Void[0]);
	}

	public static void getSearchKeywords(Context var0,
			ApiAsyncTask.ApiRequestListener var1) {
		HashMap var2 = new HashMap(1);
		var2.put("size", Integer.valueOf(15));
		(new ApiAsyncTask(var0, ACTION_GET_SEARCH_KEYWORDS, var1, var2))
				.execute(new Void[0]);
	}

	public static void getTopRecommend(Context var0,
			ApiAsyncTask.ApiRequestListener var1) {
		HashMap var2 = new HashMap(3);
		Session var3 = Session.get(var0);
		var2.put("platform", Integer.valueOf(var3.getOsVersion()));
		var2.put("screen_size", var3.getScreenSize());
		var2.put("match_type", Integer.valueOf(var3.isFilterApps()));
		(new ApiAsyncTask(var0, ACTION_GET_TOP_RECOMMEND, var1, var2))
				.execute(new Void[0]);
	}

	public static void getTopic(Context var0,
			ApiAsyncTask.ApiRequestListener var1) {
		Session var2 = Session.get(var0);
		HashMap var3 = new HashMap(4);
		...
		(new ApiAsyncTask(var0, ACTION_GET_TOPIC, var1, var3))
				.execute(new Void[0]);
	}
	...
	public static void login(Context context,
		...
		hmap.put("username", username);
		hmap.put("password", password);
		(new ApiAsyncTask(context, ACTION_LOGIN, requestListener, hmap))
				.execute(new Void[0]);
	}

	public static void markFollowedRead(Context var0, String var1,
			ApiAsyncTask.ApiRequestListener var2) {
		HashMap var3 = new HashMap(1);
		Session var4 = Session.get(var0);
		var3.put("platform", Integer.valueOf(var4.getOsVersion()));
		var3.put("screen_size", var4.getScreenSize());
		...
		var3.put("uid", var9);
		(new ApiAsyncTask(var0, ACTION_MARK_READ, var2, var3))
				.execute(new Void[0]);
	}

	public static void purchaseProduct(Context var0,
			ApiAsyncTask.ApiRequestListener var1, String var2, String var3) {
		Session var4 = Session.get(var0);
		...
		var7.put("password", var5);
		var7.put("verify_code", var6);
		(new ApiAsyncTask(var0, ACTION_PURCHASE_PRODUCT, var1, var7))
				.execute(new Void[0]);
	}

	public static void queryAliPayResult(Context var0,
			ApiAsyncTask.ApiRequestListener var1, String var2) {
		HashMap var3 = new HashMap(1);
		var3.put("orderNo", var2);
		(new ApiAsyncTask(var0, ACTION_QUERY_ALIPAY_RESULT, var1, var3))
				.execute(new Void[0]);
	}

	public static void queryChargeResult(Context var0,
			ApiAsyncTask.ApiRequestListener var1, String var2) {
		HashMap var3 = new HashMap(1);
		var3.put("order_id", var2);
		(new ApiAsyncTask(var0, ACTION_QUERY_CHARGE_BY_ORDERID, var1, var3))
				.execute(new Void[0]);
	}

	public static void queryFoolowStatus(Context var0,
			ApiAsyncTask.ApiRequestListener var1, String var2) {
		HashMap var3 = new HashMap(1);
		Session var4 = Session.get(var0);
		String var5;
		...
		var3.put("uid", var5);
		var3.put("promotion_id", var2);
		(new ApiAsyncTask(var0, ACTION_FOLLOW_MASTER, var1, var3))
				.execute(new Void[0]);
	}
	...
	public static void register(Context var0,
		...
		var5.put("email", var4);
		(new ApiAsyncTask(var0, ACTION_REGISTER, var1, var5))
				.execute(new Void[0]);
	}

	public static void reportIftttResult(Context var0, String var1,
		...
		(new ApiAsyncTask(var0, ACTION_IFTTT_REPORT,
				(ApiAsyncTask.ApiRequestListener) null, var5))
				.execute(new Void[0]);
	}

	public static void requestFollowMaster(Context var0,
			ApiAsyncTask.ApiRequestListener var1, String var2, String var3) {
		...
		(new ApiAsyncTask(var0, ACTION_FOLLOW_MASTER, var1, var4))
				.execute(new Void[0]);
	}

	public static void search(Context var0,
			ApiAsyncTask.ApiRequestListener var1, int var2, int var3, int var4,
			String var5) {
		Session var6 = Session.get(var0);
		...
		var7.put("match_type", Integer.valueOf(var6.isFilterApps()));
		(new ApiAsyncTask(var0, ACTION_SEARCH, var1, var7))
				.execute(new Void[0]);
	}
	...
	public static void submitAllInstalledApps(Context var0) {
		...
		var1.put("appList", "");
		(new ApiAsyncTask(var0, ACTION_SYNC_APPS,
				(ApiAsyncTask.ApiRequestListener) null, var1))
				.execute(new Void[0]);
	}

	public static void submitDownloadLog(Context var0,
			ApiAsyncTask.ApiRequestListener var1, String var2, String var3,
			String var4, String var5, int var6, String var7) {
		...
		(new ApiAsyncTask(var0, ACTION_DOWN_REPORT, var1, var9))
				.execute(new Void[0]);
	}

	public static void submitLogs(final Context var0, final int var1,
			final String var2) {
		HashMap var3 = new HashMap(2);
		var3.put("module", var2);
		var3.put("level", Integer.valueOf(var1));
		(new ApiAsyncTask(var0, ACTION_INSERT_LOG,
				new ApiAsyncTask.ApiRequestListener() {
	...
	public static void syncBuyLog(Context var0,
			ApiAsyncTask.ApiRequestListener var1) {
		Session var2 = Session.get(var0);
		HashMap var3 = new HashMap(1);
		var3.put("uid", var2.getUid());
		(new ApiAsyncTask(var0, ACTION_SYNC_BUYLOG, var1, var3))
				.execute(new Void[0]);
	}

	public static void syncCardInfo(Context var0,
			ApiAsyncTask.ApiRequestListener var1) {
		Session var2 = Session.get(var0);
		HashMap var3 = new HashMap(1);
		var3.put("local_version", Integer.valueOf(var2.getCreditCardVersion()));
		(new ApiAsyncTask(var0, ACTION_SYNC_CARDINFO, var1, var3))
				.execute(new Void[0]);
	}

	public static void unbindAccount(Context var0,
			ApiAsyncTask.ApiRequestListener var1) {
		(new ApiAsyncTask(var0, ACTION_UNBIND, var1, (Object) null))
				.execute(new Void[0]);
	}
}
