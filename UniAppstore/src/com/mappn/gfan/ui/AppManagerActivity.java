...
import com.mappn.gfan.ui.AppsUpdateActivity;
import com.mappn.gfan.ui.DownloadManagerActivity;
...
public class AppManagerActivity extends BaseTabActivity {
   ...
   protected void onCreate(Bundle var1) {
      ...
      IntentFilter var2 = new IntentFilter("com.mappn.gfan.download.intent");
      this.registerReceiver(this.mClickReceiver, var2);
      IntentFilter var4 = new IntentFilter("com.mappn.gfan.theme");
