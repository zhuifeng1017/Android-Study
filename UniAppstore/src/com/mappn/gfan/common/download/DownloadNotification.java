	...
	private void updateActiveNotification() {
		...
		if (cursor != null) {
			...
			while (iterator.hasNext()) {
				...
				remoteviews = new RemoteViews("com.mappn.gfan", 0x7f030055);
				...
				intent.setClassName("com.mappn.gfan",
	...
	private void updateCompletedNotification() {
		...
		if (cursor != null) {
			...
			while (!cursor.isAfterLast()) {
				...
				intent2.setClassName("com.mappn.gfan",
						DownloadReceiver.class.getName());
				...
				intent3.setClassName("com.mappn.gfan",
						DownloadReceiver.class.getName());
