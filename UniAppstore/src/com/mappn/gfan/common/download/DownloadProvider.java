...
public final class DownloadProvider extends ContentProvider {
   ...
   public int delete(Uri var1, String var2, String[] var3) {
      ...
      case 2:
         ...
         int var7 = var4.delete("downloads", var6.getSelection(), var6.getParameters());
   ...
   public Uri insert(Uri var1, ContentValues var2) {
      ...
      long var9 = var3.insert("downloads", (String)null, var4);
      Uri var12;
      if(var9 == -1L) {
   ...
   public Cursor query(Uri var1, String[] var2, String var3, String[] var4, String var5) {
      ...
      if(var7 == -1) {
         ...
         Object var9 = var6.query("downloads", var2, var8.getSelection(), var8.getParameters(), (String)null, (String)null, var5);
         if(var9 != null) {
   ...
   public int update(Uri var1, ContentValues var2, String var3, String[] var4) {
      ...
      case 2:
         ...
         if(var2.size() > 0) {
            ...
            var13 = var5.update("downloads", var2, var12.getSelection(), var12.getParameters());
            if(var13 > 0) {
               var10 = true;
            }
         } else {
   ...
   private final class DatabaseHelper extends SQLiteOpenHelper {
      ...
      public DatabaseHelper(Context var2) {
         super(var2, "downloads.db", (CursorFactory)null, 109);
      }
